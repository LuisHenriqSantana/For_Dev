...
void main() {
  ...
  void mockSaveCurrentAccountError() {
    mockSaveCurrentAccountCall().thenThrow(DomainError.emailInUse);
  }
  ...
  test('Should call Validation wih correct name', () {
  ...
  test('Should call Validation wih correct password', () {
  ...
  test('Should call Validation wih correct passwordConfirmation', () {
